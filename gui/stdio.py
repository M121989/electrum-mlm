...
from electrum_mlm.util import format_satoshis, set_verbosity
from electrum_mlm.bitcoin import is_address, COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Mktcoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-mlm setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-mlm setconfig' to change your settings")
        return True
