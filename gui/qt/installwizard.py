...
from electrum_mlm import Wallet, WalletStorage
from electrum_mlm.util import UserCancelled, InvalidPassword
from electrum_mlm.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Electrum-MLM  -  ' + _('Install Wizard'))
        self.app = app
    ...
    def run_and_get_wallet(self, get_wallet_from_daemon):
        ...
        self.set_layout(vbox, title=_('Electrum-MLM wallet'))
    ...
    def init_network(self, network):
        message = _("Electrum-MLM communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let Electrum-MLM "
