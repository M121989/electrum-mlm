...
# (str) Package name
package.name = ElectrumMLM

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrummlm
...
requirements = python3crystax==3.6, android, openssl, plyer, kivy==master, x17_hash==1.5
...
android.add_activities = org.electrummlm.qr.SimpleScannerActivity
