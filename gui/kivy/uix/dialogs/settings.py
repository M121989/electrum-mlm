...
from electrum_mlm.util import base_units_list
from electrum_mlm.i18n import languages
from electrum_mlm_gui.kivy.i18n import _
from electrum_mlm.plugins import run_hook
from electrum_mlm import coinchooser

from .choice_dialog import ChoiceDialog

Builder.load_string('''
#:import partial functools.partial
#:import _ electrum_mlm_gui.kivy.i18n._

<SettingsDialog@Popup>
    id: settings
    title: _('Electrum-MLM Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Mktcoin amounts.")
